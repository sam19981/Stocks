...
1. Place the jar file and the following files in the same folder as Stocks.jar:
    - UserDetails.csv
    - stockDirectory folder (consists of StockSymbols.csv)
    - users folder (already has details regarding 2 users with files - karthikjb10File.txt and Sam19981.txt)

NOTE: Folder copyToSameLocationAsJar contains UserDetails.csv, stockDirectory folder (consists of StockSymbols.csv) and users folder. Please place the jar in the copyToSameLocationAsJar folder and run it or copy the contents from this folder and place it in the folder where jar is present.

2. The program allows the users to load data in xml format whose template is as below:

Template for a user with 2 Portfolios and 1 Stock in each
<?xml version="1.0" encoding="UTF-8" standalone="no"?>
<user>
    <username>karthikjb10</username>  //username for the user to be loaded
    <portfolio id="Emergency">         //Name of the portfolio is unique and is the id
        <stock id="Google">        //Name of the stock is unique within the Portfolio and is the id
            <cost>67.0695</cost>     //Purchase value of the stock
            <quantity>20.0</quantity>  //Quantity(Shares) of the stock purchased
            <time>2020/03/03</time>   //Time of the stock purchase
            <symbol>GOOG</symbol>     //Ticker symbol of the stock purchased
        </stock>
    </portfolio>
    <portfolio id="College">
        <stock id="Microsoft">
            <cost>119.97</cost>
...
3. How to create a portfolio with 3 different stocks,
a second portfolio with 2 different stocks and query their value on a specific date

Step 1. Run the Stocks.jar with the commmand  java -jar Stocks.jar
having all the prerequisite files in the same folder as the jar.

Step 2.
Select the option "N" as we are a new user logging in information

Step 3.
Enter a unique name identifying the user.
The username has the following restrictions:
a. Must be unique.
b. Has to be longer than or equal to 5 but lesser than or equal to 30 characters.
c. Has to be alphanumeric but '_' is the exception.

Step 4.
Enter a password to be associated with the user.
The password has the following restrictions:
a. Is of length greater than or equal to length 5.
b. Does not contain blank spaces in it.
c. Has digits in it.

Step 5.
Receiving of the greeting message, "Hello %username%" indicates the successful creation of the user.

The details of a portfolio can be fed in through 2 ways. Through-
A. File
B. Step-by-Step input


Step 6. Pass the value "F" to opt for File input

i. File input:
Step i.
Place the file created in the Instructions Step 2 template format to load the data.

Template files "Sam19981.txt" and "karthikjb10File.txt" containing a user with 2 portfolios with 1 having 3 different stocks
and other having 2 different stocks is placed in the users folder. Please feel free to use it.

Step ii.
Pass just the name of the file from which input has to be read into the Text UI.

Step iii.
The user will be able to see another successful greeting given the file was of the correct format.

Step iv.
We can now select one of these 4 options:
...
Enter "C" as we want to compute the portfolio's value on a specific date.

Step v.
The UI shows a list of portfolio and its corresponding stocks to choose from.

Enter the name of one of the Portfolios, for example for the sample file enter:
College Funds

Step vi.
Input the day on which computation has to be made.
For example 30

Step vii.
Input the month on which the computation has to be made.
For example 3

Step viii.
Input the year on which the computation has to be made.
For example 2022

Step ix.
The UI gives the total computation for the portfolio we wanted.


Pass the value "I" after the Step 5 to use Step by Step input

B.
Step-by-Step Input:

Step i.
A new file would be created i the users folder to track the information of this new user.

The UI asks the user for number of portfolios to be created.
In this example use 2

Step ii.
Enter the name of the Portfolio 1
For example: "Emergency Funds"

Subsequently enter the name of the Portfolio 2
For example: "College Funds"

Step iii.
The UI will now ask the user to input the number of stocks for Portfolio 1
i.e Emergency Funds in the example

Enter 3 as we need 3 stocks

Step iv.
Stock specific information is asked from now

Input the Stock name
For instance Google

Step v.
Enter the quantity (Shares to be held)
For instance 100
...
For instance for Google it is GOOG

Step x.
Repeat the procedure from Step iv to Step ix for the next 2 stocks

Step xi.
The UI will now ask for the number of stocks to held for the Second Portfolio
i.e. College Funds in the example

Enter 2 for this example

Step x.
Repeat the procedure from Step iv to Step ix to input the stock details for the 2 stocks.

Step xi.
After successful entry of the portfolio/stock details the user will be greeted with his.
...
4. Our program supports upto 1000 companies listed below:
...
Morgan Stanley	MS
SAP Aktiengesellschaft Systeme, Anwendungen, Produkt	SAP
Sprint  Nextel Corporation	S
Oracle Corporation	ORCL
Eli Lilly and Company	LLY
Allianz Aktiengesellschaft	AZ
Goldman Sachs Group, Inc. (The)	GS
Apple Computer, Inc.	AAPL
AXA	AXA
American Home Products Corporation	WYE
STATOIL ASA	STO
eBay Inc.	EBAY
...
British American Tobacco  Industries, p.l.c.	BTI
...
News Corporation Limited (The)	NWS/A
First Data Corporation	FDC
Millea Holdings Inc. ADR	MLEA
...
St. Paul Companies, Inc. (The)	STA
Applied Materials, Inc.	AMAT
BT GROUP PLC	BT
Cardinal Health, Inc.	CAH
FedEx Corporation	FDX
Bayer Aktiengesellschaft	BAY
Unilever PLC	UL
...
Wipro Limited	WIT
Imperial Tobacco Group plc	ITY
iShares MSCI EAFE Index Fund	EFA
Royal KPN N.V.	KPN
Fifth Third Bancorp	FITB
Vivendi Environnement Ord	VE
...
Structured Products Inc 8% CorTS	CFC
...
SK Telecom Corporation, Ltd.	SKM
Cendant Corporation	CD
Zimmer Holdings, Inc.	ZMH
News Corporation Limited (The)	NWS
CRH PLC	CRHCY
Praxair, Inc.	PX
...
Governor and Company of the Bank of Ireland (The)	IRE
Public Service Enterprise Group Incorporated	PEG
MedcoHealth Solutions Inc	MHS
Marsh & McLennan Companies, Inc.	MMC
Telefonos de Mexico SA de CV Ser A Spons ADR	TMX
FirstEnergy Corporation	FE
FPL Group, Inc.	FPL
Electronic Arts Inc.	ERTS
LG.PHILIPS	LPL
PUBLIC SVC ELEC & GAS CO	PEG^A
McKesson Corporation	MCK
Phelps Dodge Corporation	PD
AngloGold Ashanti Ltd.	AU
Becton, Dickinson and Company	BDX
Banco Itau Holding Financeira SA (Holding Co)	ITU
...
KeyCorp	KEY
WOLSELEY PLC	WOS
Bear Stearns Companies, Inc (The)	BSC
Santa Fe International Corporation	GSF
...
TRANSCANADA CORP	TCA^
Reed Elsevier PLC	RUK
M&T Bank Corporation	MTB
Kirin Brewery Company, Limited	KNBWY
TELEKOM AUSTRIA AG	TKA
Celgene Corporation	CELG
International Game Technology	IGT
Koninklijke Ahold, N.V.	AHO
Korea Telecom Corporation	KTC
Freeport-McMoRan Copper & Gold, Inc.	FCX
COMPANHIA DE BEBIDAS DAS AME	ABV/C
...
Open Joint Stock Company Vimpel-Communications""	VIP
...
Hanson plc.(Holding Company)	HAN
Jabil Circuit, Inc.	JBL
Zions Bancorporation	ZION
Expedia, Inc.	EXPE
IVAX Corporation	IVX
MBIA, Inc.	MBI
iShares Russell 2000 Index Fund	IWM
Serono International S.A.	SRA
...
Telecom Corporation of New Zealand Limited	NZT
...
HOSPIRA INC	HSP
SODEXHO ALLIANCE SA	SDX
Cintas Corporation	CTAS
Barr Pharmaceuticals, Inc.	BRL
Host Marriott Financial Trust	HMT
...
Joy Global Inc.	JOYG
Royal & SunAlliance Insurance Group PLC	RSA
...
Sepracor Inc.	SEPR
Assurant, Inc.	AIZ
Washington Post Company (The)	WPO
...
Health Net Inc.	HNT
Formento Economico Mexicano S.A. de C.V.	FMX
Lexmark International, Inc.	LXK
iShares Russell 1000 Value Index Fund	IWD
THOMSON multimedia S.A.	TMS
Arch Coal, Inc.	ACI
...
Thermo Electron Corporation	TMO
...
Avaya Inc.	AV
Alliance Capital Management Holding L.P.	AC
...
Trend Micro Incorporated	TMIC
